...
class ArticuloRoutes {
	...
	config(): void {
		...
		this.router.get('/listByPeriodo/:ini/:fin/:idProfesor',articuloController.listByPeriodo);
		this.router.delete('/eliminarAutorByArticulo/:idProfesor/:idArticulo', articuloController.eliminarAutorByArticulo);
