...
class ArticuloRoutes {
    ...
    config() {
        ...
        this.router.get('/listByPeriodo/:ini/:fin/:idProfesor', articuloController_1.articuloController.listByPeriodo);
        this.router.delete('/eliminarAutorByArticulo/:idProfesor/:idArticulo', articuloController_1.articuloController.eliminarAutorByArticulo);
    }
}
