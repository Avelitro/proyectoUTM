...
class ProfesoresController {
    ...
    listAutorByArticulo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const respuesta = yield database_1.default.query(`SELECT P.nombresP, P.idProfesor, AYP.pos FROM Profesores P INNER JOIN ArticuloYProfesor AYP ON AYP.idProfesor=P.idProfesor WHERE idArticulo = ${idArticulo}`);
            res.json(respuesta);
        });
    }
